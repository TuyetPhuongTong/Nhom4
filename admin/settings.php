...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Logo đã được cập nhật thành công!';
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Biểu tượng trang web đã được cập nhật thành công!';
...
if(isset($_POST['form3'])) {
    ...
    $success_message = 'Cài đặt nội dung chung đã được cập nhật thành công.';
...
if(isset($_POST['form4'])) {
    ...
    $success_message = 'Thông tin cài đặt biểu mẫu liên hệ đã được cập nhật thành công.';
}
...
if(isset($_POST['form5'])) {
    ...
    $success_message = 'Cài đặt thanh bên đã được cập nhật thành công.';
}
...
if(isset($_POST['form6_0'])) {
    ...
    $success_message = 'Cài đặt bật/tắt phần đã được cập nhật thành công.';
}
...
if(isset($_POST['form6'])) {
    ...
    $success_message = 'Cài đặt Meta trang chủ đã được cập nhật thành công.';
}
...
if(isset($_POST['form6_7'])) {
    ...
    if(empty($_POST['cta_title'])) {
        $valid = 0;
        $error_message .= 'Tiêu đề Call to Action không được để trống.<br>';
    }
    ...
    if(empty($_POST['cta_read_more_text'])) {
        $valid = 0;
        $error_message .= 'Văn bản "Đọc thêm" của Call to Action không được để trống<br>';
    }

    if(empty($_POST['cta_read_more_url'])) {
        $valid = 0;
        $error_message .= 'URL "Đọc thêm" của Call to Action không được để trống<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Dữ liệu Call to Action Data đã được cập nhật thành công.';
...
if(isset($_POST['form6_4'])) {
    ...
    if(empty($_POST['featured_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Phụ đề sản phẩm nổi bật không được để trống<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Dữ liệu sản phẩm nổi bật đã được cập nhật thành công.';
...
if(isset($_POST['form6_5'])) {
    ...
    if(empty($_POST['latest_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Phụ đề sản phẩm mới nhất không được để trống<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Dữ liệu sản phẩm mới nhất đã được cập nhật thành công.';
...
if(isset($_POST['form6_6'])) {
    ...
    if(empty($_POST['popular_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Phụ đề sản phẩm phổ biến không được để trống<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Dữ liệu sản phẩm phổ biến đã được cập nhật thành công.';
...
if(isset($_POST['form6_3'])) {
        ...
        $success_message = 'Bản tin đã được cập nhật thành công.';
...
if(isset($_POST['form7_1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang Đăng nhập đã được cập nhật thành công.';
...
if(isset($_POST['form7_2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang Đăng ký đã được cập nhật thành công.';
...
if(isset($_POST['form7_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang Đổi mật khẩu đã được cập nhật thành công.';
...
if(isset($_POST['form7_6'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang Tìm kiếm đã được cập nhật thành công.';
...
if(isset($_POST['form7_7'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang Giỏ hàng đã được cập nhật thành công.';
...
if(isset($_POST['form7_8'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang Thanh toán đã được cập nhật thành công.';
...
if(isset($_POST['form7_9'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Banner trang Sản phẩm đã được cập nhật thành công.';
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Script Head và Body đã được cập nhật thành công.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">Biểu tượng Website</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Khung iFrame Bản đồ Liên hệ </label>
                                        <div class="col-sm-9">
                        ...
                        <div class="tab-pane" id="tab_4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Lời cảm ơn trong Email Liên hệ</label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_6">
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <h3>Phần Sản phẩm mới</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Tiêu đề sản phẩm mới<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="latest_product_title" value="<?php echo $latest_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Phụ đề sản phẩm mới<span>*</span></label>
                                        <div class="col-sm-8">
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Văn bản cho Bản tin</label>
                                        <div class="col-sm-8">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        ...
                                        <input type="submit" class="btn btn-primary btn-xs" value="Thay dổi" style="margin-top:10px;" name="form7_1">
                                    </td>
                                    </form>
                                </tr>
                                <tr>
                        ...
                        <div class="tab-pane" id="tab_10">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Mã Trước Thẻ &lt;/head&gt; tag </label>
                                            <div class="col-sm-8">
                                                <textarea name="before_head" class="form-control" cols="30" rows="10"><?php echo $before_head; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Mã Sau Thẻ &lt;body&gt; tag </label>
                                            <div class="col-sm-8">
                                                <textarea name="after_body" class="form-control" cols="30" rows="10"><?php echo $after_body; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Mã Trước Thẻ &lt;/body&gt; tag </label>
                                            <div class="col-sm-8">
