            ...
            <?php
                ...
                foreach ($result as $row) {
                    ...
                    <div class="col-md-4" style="margin-bottom: 30px;">
                        <div class="item" style="text-align: center; background:rgb(140, 214, 233); border: 1px solid #ddd; border-radius: 10px; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); transition: all 0.3s ease;">
