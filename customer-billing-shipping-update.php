...
if (isset($_POST['form1'])) {
    ...
    $success_message = "Thông tin thanh toán và vận chuyện đã được cập nhật thành công";
            ...
            <div class="col-md-12">
                <div class="user-content">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3><?php echo "Cập nhật địa chỉ thanh toán"; ?></h3>
                            ...
                            <div class="col-md-6">
                                <h3><?php echo "Cập nhật địa chỉ giao hàng"; ?></h3>
                                <div class="form-group">
                                    <label for=""><?php echo "Tên khách hàng"; ?></label>
