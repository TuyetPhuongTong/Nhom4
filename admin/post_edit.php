					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<?php if($photo): ?>
								<img src="uploads/<?php echo $photo; ?>" alt="Ảnh bài viết" style="width:200px; margin-top:10px;">
								<?php endif; ?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control" name="post_content" id="editor1" style="height:140px;"><?php echo $post_content; ?></textarea>
							</div>
						</div>
						<div class="form-group">
