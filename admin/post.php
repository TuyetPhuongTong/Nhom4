...
//CẬP NHẬT DỮ LIỆU
          ...
          $statement->execute(array($_POST['post_title'],$_POST['post_slug'],$_POST['post_content'],$_POST['post_date'],$_POST['photo'],$_POST['category_id'],$_POST['total_view'],$_POST['meta_title']));
     }
